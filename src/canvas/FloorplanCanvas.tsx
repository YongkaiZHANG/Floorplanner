...
const SCALE_FACTOR = 100; // 1um = 100px on screen
...
export const FloorplanCanvas: React.FC = () => {
  ...
  return (
    <div className="canvas-container" ref={containerRef}>
      ...
      <button 
        onClick={exportSVG}
        style={{ position: 'absolute', top: '16px', right: '16px', padding: '8px 16px', background: '#3b82f6', color: 'white', borderRadius: '4px', border: 'none', cursor: 'pointer', fontWeight: 'bold', boxShadow: '0 4px 6px -1px rgba(0, 0, 0, 0.1)' }}
      >
        Export SVG
      </button>
    </div>
